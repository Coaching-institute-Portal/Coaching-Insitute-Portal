...
<style>
  ...
  <div id="nav">
      ...
      <section>
                ...
                <div class="container">
                  <h2>Delete</h2>
                  <p>Please enter the Student ID and name in the form to delete from database!!!!</p>
                  <form action="s_delete.php" method="post">
                    <div class="row">
                    <div class="col-25">
                      <label for="name">Student ID</label></div>
                      <div class="col-75"><input type="text" id="id" name="id"  placeholder="1" required>
                    </div></div>
                    <div class="row">
                    <div class="col-25">
                      <label for="c_number">Student Name</label></div>
                      <div class="col-75">
                      <input type="text" id="name" name="name" pattern="[A-Za-z]+" placeholder="John Francis Kennedy" 
