...
<html>
  ...
  <div id="nav">
      ...
      <section>
         ...
         <div class="container">
                  <h2>Staff please register here!!</h2>
                  <p>Please register yourself using below form</p>
                  <form action="t_insert.php" method="post">
                    <div class="row">
                    <div class="col-25">
                      <label for="name">Full Name</label></div>
                      <div class="col-75"><input type="text" id="name" name="name" pattern="[A-Za-z]+ \" title="Provide Your Proper name and no space is allowed"required></div>
                    </div>
                    <div class="row">
                    <div class="col-25">
                  ...
                  <div class="row">
                    <div class="col-25">
                      <label for="Address">Resedential_Address</label>
                    </div>
                    <div class="col-75">
                    ...
                    <div class="col-25">
                      ...
                      <div class="col-75">
                      <input type="tel" name="Phone_Number" id="phone" pattern="[0-9]{10}" title="please enter your proper contact number!!!" required></div>
                      </div>
                       <div class="row">
                      <div class="col-25">
                    ...
                    <div class="col-75">  <input type="password" name="password" id="n_p" pattern="[A-Za-z]{1,13}" title="numbers and special characters are not allowed"required></div>
                      <div class="col-75"><input type="checkbox" onclick="myFunction()">Show Password</div>
                      </div>
                      <div class="row">
                    <div class="col-25">
                      <label for="c_password">Confirm_Password</label></div>
                      <div class="col-75"><input type="password" name="confirm_password"  id="c_p" pattern="[A-Za-z]{1,13}"  required>
                      </div>
                      <div class="col-75">
 ...
 <footer style="background-color:  #181818; display: block; border-top: #FFFFFF solid 2px; background-size: 100%;
