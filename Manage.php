              ...
              <div>
                <div>
                  <div id="center">
                    <h3>Options</h3>
                    <pre>
 <a href="student_delete.php" style="font-family:lucida sans;">Delete Students</a>

<a href="staff_delete.php" style="font-family:lucida sans;">Delete Tutors</a>

<a href="tutor_select.php" style="font-family:lucida sans;">Show Tutor List</a>

<a href="student_select.php" style="font-family:lucida sans;">Show Student List</a>
                    </pre>
                  </div>
                </div>
              </div>
