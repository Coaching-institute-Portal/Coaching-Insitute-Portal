...
<style>
  ...
  <div id="nav">
      ...
      <section>
                ...
                <div class="container">
                  <h2>Delete</h2>
                  <p>Please enter the tutor ID and name in the form to delete from database!!!!</p>
                    <form action="t_delete.php" method="post">
                    <div class="row">
                    <div class="col-25">
                      <label for="name">Tutor ID</label>
                    </div>
                      <div class="col-75">
                        <input type="number" id="id" name="id"  placeholder="1"
                        required>
                    </div>
                  </div>
                    <div class="row">
                    <div class="col-25">
                      <label for="c_number">Tutor Name</label></div>
                      <div class="col-75">
                      <input type="text" id="name" name="name" pattern="[A-Za-z]+" placeholder="John Francis Kennedy" title="Provide Your Proper name and no space is allowed" required>
                    </div>
                  </div>
                  <br><br>
                    <div>
